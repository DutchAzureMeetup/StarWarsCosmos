...
3. Open the **Mission1** class and examine the **Seed** method. This method first creates the database and collection if they doesn’t exist yet (see the **Connect** method). Then it should import the flight data into the collection.
